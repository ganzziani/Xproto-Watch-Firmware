...
// This function has less randomness compared to prandom but is a little faster
...
const unsigned char TuneIntro[] PROGMEM = {
    20, NOTE_C8, 10, NOTE_OFF,
    20, NOTE_D8, 10, NOTE_OFF,
    40, NOTE_E8, 
    0
};
...
const unsigned char TuneAlarm4[] PROGMEM = {    // Adventures of Gabito
    ...
    20,  NOTE_C7, 20,  NOTE_OFF,
    20,  NOTE_G6, 20,  NOTE_OFF,
    20,  NOTE_D7, 60,  NOTE_OFF,
    20,  NOTE_G6, 60,  NOTE_OFF,
    20,  NOTE_D7, 60,  NOTE_OFF,
    20,  NOTE_G6, 60,  NOTE_OFF,
    20,  NOTE_C7, 60,  NOTE_OFF,
    20,  NOTE_G7, 20,  NOTE_OFF,
    20,  NOTE_F7, 60,  NOTE_OFF,
    20,  NOTE_E7, 60,  NOTE_OFF,
    20,  NOTE_C7, 140, NOTE_OFF,
    0
};
...
const unsigned char TuneAlarm7[] PROGMEM = {    // My First Song
    20,  NOTE_C7, 25, NOTE_OFF,
    20,  NOTE_C7, 25, NOTE_OFF,
    20,  NOTE_C7, 25, NOTE_OFF,
    20,  NOTE_C7, 25, NOTE_OFF,
    20,  NOTE_G7, 25, NOTE_OFF,
    20,  NOTE_G7, 25, NOTE_OFF,
    20,  NOTE_G7, 25, NOTE_OFF,
    20,  NOTE_G7, 25, NOTE_OFF,
    20,  NOTE_F7, 25, NOTE_OFF,
    20,  NOTE_F7, 25, NOTE_OFF,
    20,  NOTE_F7, 25, NOTE_OFF,
    20,  NOTE_F7, 25, NOTE_OFF,
    20,  NOTE_G7, 25, NOTE_OFF,
...
const unsigned char TuneAlarm8[] PROGMEM = {    // Medicine
    ...
    20,  NOTE_F7, 25, NOTE_OFF,
    20,  NOTE_C7, 25, NOTE_OFF,   
    20,  NOTE_D7, 25, NOTE_OFF,
    20,  NOTE_C7, 75, NOTE_OFF,
    0
};

const unsigned char TuneAlarm9[] PROGMEM = {    // Vengaboys
    20,  NOTE_G7, 10,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_G7, 70,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_G7, 10,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_G7, 70,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_A7, 10,  NOTE_OFF,
    20,  NOTE_A7, 40,  NOTE_OFF,
    20,  NOTE_A7, 70,  NOTE_OFF,
    20,  NOTE_A7, 40,  NOTE_OFF,
    20,  NOTE_B7, 10,  NOTE_OFF,
    20,  NOTE_B7, 40,  NOTE_OFF,
    20,  NOTE_B7, 70,  NOTE_OFF,
    20,  NOTE_C8, 40,  NOTE_OFF,
    20,  NOTE_E7, 10,  NOTE_OFF,
    20,  NOTE_E7, 40,  NOTE_OFF,
    20,  NOTE_E7, 70,  NOTE_OFF,
    20,  NOTE_E7, 40,  NOTE_OFF,
    20,  NOTE_E7, 10,  NOTE_OFF,
    20,  NOTE_E7, 40,  NOTE_OFF,
    20,  NOTE_E7, 70,  NOTE_OFF,
    20,  NOTE_E7, 40,  NOTE_OFF,
    20,  NOTE_D7, 10,  NOTE_OFF,
    20,  NOTE_D7, 40,  NOTE_OFF,
    20,  NOTE_D7, 70,  NOTE_OFF,
    20,  NOTE_D7, 40,  NOTE_OFF,
    20,  NOTE_C7, 10,  NOTE_OFF,
    20,  NOTE_C7, 40,  NOTE_OFF,
    20,  NOTE_C7, 70,  NOTE_OFF,
    20,  NOTE_C7, 40,  NOTE_OFF,
    20,  NOTE_G7, 10,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_G7, 70,  NOTE_OFF,
    ...
    20,  NOTE_C7, 70,  NOTE_OFF,
    20,  NOTE_C7, 40,  NOTE_OFF,
    20,  NOTE_F7, 10,  NOTE_OFF,
    20,  NOTE_F7, 40,  NOTE_OFF,
    20,  NOTE_F7, 70,  NOTE_OFF,
    20,  NOTE_F7, 40,  NOTE_OFF,
    20,  NOTE_G7, 10,  NOTE_OFF,
    20,  NOTE_G7, 40,  NOTE_OFF,
    20,  NOTE_G7, 70,  NOTE_OFF,
    ...
    20,  NOTE_C8, 40,  NOTE_OFF,
    20,  NOTE_C8, 70,  NOTE_OFF,
    20,  NOTE_D8, 40,  NOTE_OFF,
    20,  NOTE_A_7, 10, NOTE_OFF,
    20,  NOTE_A_7, 40, NOTE_OFF,
    20,  NOTE_A_7, 70, NOTE_OFF,
    20,  NOTE_A_7, 40, NOTE_OFF,
    20,  NOTE_A_7, 10, NOTE_OFF,
    20,  NOTE_A_7, 40, NOTE_OFF,
    20,  NOTE_A_7, 70, NOTE_OFF,
